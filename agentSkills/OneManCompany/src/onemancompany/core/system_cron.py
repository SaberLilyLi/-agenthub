...
@system_cron("heartbeat", interval="1m", description="员工 API 连接检查")
...
@system_cron("review_reminder", interval="5m", description="评审超时提醒")
...
@system_cron("config_reload", interval="30s", description="定期从磁盘重载配置")
...
@system_cron("talent_market_keepalive", interval="15s", description="人才市场 MCP 保活")
...
@system_cron("project_progress_watchdog", interval="10m", description="项目进度看门狗 — 防止项目卡住", enabled_by_default=False)
...
@system_cron("holding_timeout_sweep", interval="10m", description="暂挂任务超时扫描 — 自动将过期任务标记为失败")
...
@system_cron("schedule_cleanup", interval="10m", description="清理无归属的计划条目")
