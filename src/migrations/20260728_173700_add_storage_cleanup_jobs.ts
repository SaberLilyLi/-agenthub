...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
    CREATE TYPE "public"."enum_payload_jobs_log_task_slug"
      AS ENUM('inline', 'deleteRejectedSkillArchive');
    CREATE TYPE "public"."enum_payload_jobs_log_state"
      AS ENUM('failed', 'succeeded');
    CREATE TYPE "public"."enum_payload_jobs_task_slug"
      AS ENUM('inline', 'deleteRejectedSkillArchive');
    ...
    ALTER TABLE "payload_jobs_log"
      ...
      FOREIGN KEY ("_parent_id") REFERENCES "public"."payload_jobs"("id")
